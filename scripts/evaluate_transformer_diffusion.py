...
def evaluate_transformer_diffusion(csv_path="outputs/diffusion_del4_v4.csv",
                                   checkpoint_path="checkpoints_transformer_ddpm/transformer_ddpm_best.pt",
                                   Th=16, max_events=200, K=10, num_steps=50, dt=0.1):
    ...
    model = TransformerTrajectoryDiffusion(traj_dim=2, cond_dim=2, hidden_dim=64, num_heads=4, num_layers=2, max_len=Th)
