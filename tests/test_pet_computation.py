...
def test_pet_sequential_a_to_b():
    ...
    pet, first, second, frame_ref = _compute_pet_from_windows(
        a_entry=80, a_exit=90, b_entry=105, b_exit=115, fps=30.0
    )
...
def test_pet_overlap_returns_none():
    ...
    result = _compute_pet_from_windows(a_entry=80, a_exit=95, b_entry=90, b_exit=105, fps=30.0)
...
def test_pet_zero_on_boundary():
    ...
    pet, _, _, _ = _compute_pet_from_windows(
        a_entry=80, a_exit=90, b_entry=90, b_exit=100, fps=30.0
    )
...
def test_pet_negative_rejected():
    ...
    result = _compute_pet_from_windows(a_entry=80, a_exit=95, b_entry=85, b_exit=100, fps=30.0)
    assert result is None
