...
class TestTrackSplitter:
    def test_splits_on_large_jump(self):
        ...
        tracks = {1: pts}
        split = _split_tracks_by_gaps(
            tracks, max_frame_gap=5, max_spatial_jump=30.0, prediction_tolerance=0.0
        )
        ...
        pet_df = pd.DataFrame(
            {
                ...
                "track_a_exit_frame": [10],
                "track_b_entry_frame": [7],
                "track_b_exit_frame": [12],
                "world_traj_i": ["track_1"],
                "world_traj_j": ["track_2"],
                "traj_a_json": [
                    '[{"frame":5,"x_pixel":10,"y_pixel":20,"world_x":100,"world_y":200},{"frame":6,"x_pixel":11,"y_pixel":21,"world_x":101,"world_y":201}]'
                ],
                "traj_b_json": [
                    '[{"frame":7,"x_pixel":15,"y_pixel":25,"world_x":110,"world_y":210},{"frame":8,"x_pixel":16,"y_pixel":26,"world_x":111,"world_y":211}]'
                ],
            }
        )
