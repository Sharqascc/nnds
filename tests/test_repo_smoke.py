...
def test_expected_paths_exist():
    expected = [
        ...
        "src/analysis/grid_trajectory/trajectory_safety_analyzer.py",
        "src/analysis/analysis/safety_eval_diffusion.py",
        "src/analysis/analysis/safety_eval_diffusion_notebook.py",
        ...
        "src/diffusion/traffic_diffusion/pet_safety_metrics.py",
