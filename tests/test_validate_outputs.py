...
def test_validate_trajectory_json_missing_keys():
    pts = [
        {"frame": 1, "x_pixel": 1, "y_pixel": 1, "world_x": 1, "world_y": 1},
        {"frame": 2, "x_pixel": 2, "y_pixel": 2},
    ]  # missing world_x/world_y
    js = json.dumps(pts)
...
def test_validate_trajectory_json_all_world_none():
    pts = [
        {"frame": 1, "x_pixel": 1, "y_pixel": 1, "world_x": None, "world_y": None},
    ...
    return pd.DataFrame(
        {
            ...
            "grid_cell": ["G_A_1"],
            "traj_a_json": [
                '[{"frame":1,"x_pixel":1,"y_pixel":1,"world_x":1,"world_y":1},{"frame":2,"x_pixel":2,"y_pixel":2,"world_x":2,"world_y":2}]'
            ],
            "traj_b_json": [
                '[{"frame":1,"x_pixel":1,"y_pixel":1,"world_x":1,"world_y":1},{"frame":2,"x_pixel":2,"y_pixel":2,"world_x":2,"world_y":2}]'
            ],
...
def test_main_if_name_main_block(monkeypatch):
    ...
    with patch.object(sys, "argv", ["prog", "--help"]), pytest.raises(SystemExit):
