...
def load_eval_model(checkpoint_path, device, T=15, N=1, F=4, cond_dim=4, hidden_dim=128):
    ...
    ckpt = torch.load(checkpoint_path, map_location=device, weights_only=False)  # nosec B614 -- see comment above
