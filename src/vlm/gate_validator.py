...
class GateValidator:
    ...
    def __init__(self, groq_api_key: str, config: VLMConfig | None = None):
        self.config = config or VLMConfig()
        if Groq is None:
            raise ImportError(
                "groq package is required for GateValidator. Install with 'pip install groq'."
            )
