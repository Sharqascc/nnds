...
rm figures/nnds_full_deps.png  # (redundant)
```

**Affected files:**
- `figures/dependency_graph.png` (2.6 MB) → `figures/dependency_graph.png`
- `figures/nnds_full_deps.png` (606 B) → Remove (redundant)
